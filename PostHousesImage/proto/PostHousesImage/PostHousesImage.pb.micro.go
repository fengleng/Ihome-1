...
func (c *postHousesImageService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "PostHousesImage.Call", in)
	out := new(Response)
...
func (h *postHousesImageHandler) Call(ctx context.Context, in *Request, out *Response) error {
	return h.PostHousesImageHandler.Call(ctx, in, out)
}
