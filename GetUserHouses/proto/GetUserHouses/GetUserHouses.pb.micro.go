...
func (c *getUserHousesService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "GetUserHouses.Call", in)
	out := new(Response)
...
func (h *getUserHousesHandler) Call(ctx context.Context, in *Request, out *Response) error {
	return h.GetUserHousesHandler.Call(ctx, in, out)
}
