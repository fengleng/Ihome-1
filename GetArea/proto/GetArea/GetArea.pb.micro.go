...
func (c *getAreaService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *getAreaHandler) Call(ctx context.Context, in *Request, out *Response) error {
