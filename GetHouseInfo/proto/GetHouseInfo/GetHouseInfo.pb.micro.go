...
func (c *getHouseInfoService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *getHouseInfoHandler) Call(ctx context.Context, in *Request, out *Response) error {
